...
function checkInput() {
  ...
  if (phoneNumberValue === "") {
    ...
    setErrorMessage(phoneNumber, "Incorrect Phone Number.");
  ...
  if (checkPasswordValue === "") {
    ...
    setErrorMessage(checkPassword, "Sorry! Your password and confirm password not matched. Please input correct password.");
